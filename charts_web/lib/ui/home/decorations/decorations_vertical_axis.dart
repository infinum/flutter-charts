...
class DecorationsVerticalAxis extends HookConsumerWidget {
  const DecorationsVerticalAxis({Key? key, required this.decorationIndex})
      : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final _presenter =
        ref.watch(decorationVerticalAxisPresenter(decorationIndex));
            ...
            children: [
              SizedBox(
                ...
                child: SwitchListTile(
                  ...
                  title: Text(_presenter.showLines
                      ? 'Show lines'
                      : 'Don\'t show lines'),
              ...
              SizedBox(
                ...
                child: SwitchListTile(
                  ...
                  title: Text(_presenter.showValues
                      ? 'Show values'
                      : 'Don\'t show values'),
              ...
              SizedBox(
                ...
                child: SwitchListTile(
                  ...
                  title: Text(_presenter.endWithChart
                      ? 'End with chart'
                      : 'Don\'t end with chart'),
              ...
              TextButton(
                child: Row(
                  children: [
                    Icon(Icons.format_paint, color: _presenter.lineColor),
                    const Text('Set line color')
                  ],
                ),
                onPressed: () async {
