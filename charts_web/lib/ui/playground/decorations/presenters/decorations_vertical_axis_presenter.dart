...
class DecorationVerticalAxisPresenter extends ChangeNotifier
  ...
  DecorationVerticalAxisPresenter(this.index, this._ref) {
  ...
  void updateLegendPosition(VerticalLegendPosition value) {
  ...
  void writeDecorationSource(SourceWriter writer) {
    ...
    if (valuesAlign != TextAlign.center) {
    ...
    if (legendPosition != VerticalLegendPosition.bottom) {
