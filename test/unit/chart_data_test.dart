...
void main() {
  test('Max is extracted from data', () {
    final _data = ChartData.fromList([2, 4, 6].map((e) => ChartItem<void>(e.toDouble())).toList());
  ...
  test('Data can contain just 0', () {
    final _data = ChartData.fromList([0, 0, 0, 0].map((e) => ChartItem<void>(e.toDouble())).toList());
  ...
  test('Value over axis adds to max value', () {
    final _data = ChartData.fromList(
      [2, 4, 6].map((e) => ChartItem<void>(e.toDouble())).toList(),
      valueAxisMaxOver: 2,
    );
  ...
  test('Max value is extracted even if there are multiple lists', () {
    final _data = ChartData(
      [
        ChartDataSection<void>(items: [2, 4, 6].map((e) => ChartItem<void>(e.toDouble())).toList()),
        ChartDataSection<void>(items: [8, 10, 12].map((e) => ChartItem<void>(e.toDouble())).toList())
      ],
