...
class BubbleGeometryPainter<T> extends GeometryPainter<T> {
  ...
  BubbleGeometryPainter(ChartItem<T> item, ChartData<T?> data, ItemOptions itemOptions, this.drawDataItem)
  ...
  void draw(Canvas canvas, Size size, Paint paint) {
    ...
    canvas.drawCircle(
      Offset(size.width * 0.5,
          _maxValue * _verticalMultiplier - _itemMaxValue * _verticalMultiplier + _minValue + _circleSize),
      _circleSize,
      paint,
    );
