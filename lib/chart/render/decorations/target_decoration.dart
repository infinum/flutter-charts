...
class TargetLineDecoration<T> extends DecorationPainter<T> {
  ...
  @override
  TargetLineDecoration<T> animateTo(DecorationPainter endValue, double t) {
    if (endValue is TargetLineDecoration) {
      return TargetLineDecoration<T>(
...
class TargetAreaDecoration<T> extends DecorationPainter<T> {
  ...
  @override
  TargetAreaDecoration<T> animateTo(DecorationPainter<T> endValue, double t) {
    if (endValue is TargetAreaDecoration<T>) {
      return TargetAreaDecoration<T>(
