...
class BorderDecoration extends DecorationPainter {
  ...
  void draw(Canvas canvas, Size size, ChartState state) {
    ...
    canvas.translate(
        (state.defaultPadding.left + state.defaultMargin.left) * _endWithChart,
    ...
    final _height = size.height +
        (state.defaultMargin.vertical * (1 - _endWithChart)) +
        _borderWidth.dimensions.vertical / 2;
    final _width = size.width +
        (state.defaultMargin.horizontal * (1 - _endWithChart)) -
    ...
    _drawLine(
        ...
        Offset(_width + _borderWidth.dimensions.horizontal,
            _height - (_borderWidth.bottom.width / 2)),
        Offset(-borderPadding.left, _height - (_borderWidth.bottom.width / 2)),
        _paint);
    ...
    _drawLine(
        ...
        Offset(-_borderWidth.left.width / 2 - borderPadding.left,
            -_borderWidth.top.width - borderPadding.top),
        _paint);
