...
class ItemBuilderData<T> {
  ...
  /// Item index represents index of an item in the list. This is useful when you want to have different design/colors
  /// for each item.
  ///
  ...
  /// List index represents index of an list in the data. This is useful if you have multiple lists and want to have
