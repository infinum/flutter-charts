...
class ItemBuilderData<T> {
  ...
  /// This is useful when you want to have different design/color based on item value.
  ...
  ///
  /// [
  ///   [4, 6, 3, 6, 7, 9].map((e) => BarValue(e.toDouble())).toList(),
  /// ]
  ///
  ...
  /// [
  ///   [4, 6, 3, 6, 7, 9].map((e) => BarValue(e.toDouble())).toList(),
  ///   [1, 5, 2, 3, 6, 4].map((e) => BarValue(e.toDouble())).toList(),
  /// ]
  ///
